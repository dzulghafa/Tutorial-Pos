                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="numbar" name="harga_hna" id="harga_hna" class="form-control {{ $errors->has('harga_hna') ? 'is-invalid':''}}" placeholder="Masukan Harga HNA..." value="{{ old('harga_hna') }}" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="numbar" name="harga_jual" id="harga_jual" class="form-control {{ $errors->has('harga_jual') ? 'is-invalid':''}}" placeholder="Masukan Harga Jual  ..." value="{{ old('harga_jual') }}" required>
                                <div class="invalid-feedback">
