                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_satuan" id="kode_satuan" class="form-control {{ $errors->has('kode_satuan') ? 'is-invalid':''}}" placeholder="Masukan Kode Jenis..." value="{{ $dataSatuan->FK_SAT }}" maxlength="5" required>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama-satuan" id="nama-satuan" class="form-control {{ $errors->has('nama-satuan') ? 'is-invalid':''}}" placeholder="Masukan Nama Jenis..." value="{{ $dataSatuan->FN_SAT }}" required>
                                <div class="invalid-feedback">
                                    {{ $errors->first('nama-satuan') }}
                                </div>
                            </div>
                        </div>
